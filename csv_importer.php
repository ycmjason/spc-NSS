		...
		<form action=\"csv_importer.php\" method=\"POST\">
			<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\" width=\"55%\" align=\"center\">
				...
				<tr>
					...
					<td><input type=\"text\" name=\"csvFile\" size=\"20\" class=\"inputText\"> (relative to script)</td>
				</tr>
				<tr>
...
<body>
	...
	<? echo $display_block ?>
    <p align="center">
      <input name="button2" type="button" class="style1" id="button2" onClick="window.location='adminpage.htm'" value="Admin Page" align='center'>
      <input name="button3" type="button" class="style1" id="button3" onClick="window.location='adminlogout.php'" value="Logout" align='center'>
    </p>
</body>
</html>
